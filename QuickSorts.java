...
// "and", "deeply", "religious", "people"};
    ...
    //System.out.println("before sort: "+toString(words));
      ...
      System.out.println("time to sort 'Crime and Punishment':" +(end.getTime()-start.getTime()) + " miliseconds");
      ...
      System.out.println("time to sort the presorted 'Crime and Punishment':" +(end2.getTime()-start2.getTime()) + " miliseconds");
